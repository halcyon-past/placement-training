...
test = Solution()
assert test.flipEquiv([1,2,3,4,5,6,None,None,None,7,8], [1,3,2,None,6,4,5,None,None,None,None,8,7]) == True
assert test.flipEquiv([], []) == True
assert test.flipEquiv([], [1]) == False